    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-72 flex-col glass-effect shadow-2xl">
          <div className="flex h-20 items-center justify-between px-6 border-b border-blue-200/50">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col">
        <div className="flex flex-col flex-grow glass-effect border-r border-blue-200/50 shadow-xl">
          <div className="flex h-20 items-center px-6 border-b border-blue-200/50">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl shadow-lg">
                <Sword className="h-6 w-6 text-white" />
              </div>
          ...
          <div className="p-4 border-t border-blue-200/50">
            <div className="flex items-center space-x-3 p-3 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-500">admin@ninja.com</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="lg:pl-72">
        {/* Header móvil */}
        <div className="sticky top-0 z-40 flex h-16 items-center justify-between gap-x-4 glass-effect border-b border-blue-200/50 px-4 shadow-lg lg:hidden">
          <div className="flex items-center space-x-3">
            <button
        ...
        {/* Header desktop */}
        <div className="hidden lg:block sticky top-0 z-30 glass-effect border-b border-blue-200/50 shadow-sm">
          <div className="flex h-16 items-center justify-between px-8">
            ...
            <div className="flex items-center space-x-4">
              <button className="p-2 rounded-xl hover:bg-blue-100 transition-colors relative">
                <Bell className="h-5 w-5 text-blue-600" />
                <span className="absolute -top-1 -right-1 h-3 w-3 bg-red-500 rounded-full"></span>
              </button>
              <button className="p-2 rounded-xl hover:bg-blue-100 transition-colors">
                <Settings className="h-5 w-5 text-blue-600" />
              </button>
